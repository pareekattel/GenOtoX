...
<div class="container centered-login-form">
    <div class="row">
        <div class="col">
            <form class="login-form" action="index.cfm?action=main.signupAction" method="post">
                ...
                <h6>Have an account?&nbsp;&nbsp;<a href="index.cfm?action=main.login" class="btn btn-secondary custom-btn">Login</a></h6>
            </form>
        </div>
    </div>
</div>